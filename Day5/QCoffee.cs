...
public abstract class CoffeeMakerAPI {
     ...
     */
    public abstract int getWarmerPlateStatus();
     ...
     */
    public abstract int getBoilerStatus();
     ...
     * pushed.
     */
    public abstract int getBrewButtonStatus();
    public const int BREW_BUTTON_PUSHED = 0;
    public const int BREW_BUTTON_NOT_PUSHED = 1;

    /**
     * This function turns the heating element in the boiler
     * on or off.
     */
    public abstract void setBoilerState(int boilerStatus);
    public const int BOILER_ON = 0;
    public const int BOILER_OFF = 1;
     ...
     * plate on or off.
     */
    public abstract void setWarmerState(int warmerState);
    public const int WARMER_ON = 0;
    public const int WARMER_OFF = 1;
     ...
     */
    public abstract void setIndicatorState(int indicatorState);
    public const int INDICATOR_ON = 0;
    public const int INDICATOR_OFF = 1;
     ...
     */
     public abstract void setReliefValveState(int reliefValveState);
     public const int VALVE_OPEN = 0;
     public const int VALVE_CLOSED = 1;
}
